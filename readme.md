...
[![Build status](https://travis-ci.org/jaydenseric/apollo-upload-client.svg?branch=master)](https://travis-ci.org/jaydenseric/apollo-upload-client) [![npm version](https://badgen.now.sh/npm/v/apollo-upload-client)](https://npm.im/apollo-upload-client)
